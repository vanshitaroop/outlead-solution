...
export const OurkeyClients2 = () => {
  ...
  //     {" "}
  //     <img src={client2} alt="" width="80%" />{" "}
  //   </div>,
  //   <div key={2} className="item center">
  //     <img src={client3} alt="" width="80%" />{" "}
  //   </div>,
  //   <div key={1} className="item center">
  //     {" "}
  //     <img src={client4} alt="" width="80%" />{" "}
  //   </div>,
  //   <div key={2} className="item center">
  //     <img src={client5} alt="" width="80%" />{" "}
  //   </div>,
  //   <div key={1} className="item center">
  //     {" "}
  //     <img src={client6} alt="" width="80%" />{" "}
  //   </div>,
  //   <div key={2} className="item center">
  //     <img src={client7} alt="" width="80%" />{" "}
  //   </div>,
  //   <div key={1} className="item center">
  //     {" "}
  //     <img src={client8} alt="" width="80%" />{" "}
  //   </div>,
  // ];
